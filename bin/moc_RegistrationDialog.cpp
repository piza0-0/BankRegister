...
QT_MOC_LITERAL(1, 19, 20), // "registrationComplete"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 20) // "on_pb_accept_clicked"

    },
    "RegistrationDialog\0registrationComplete\0"
    "\0on_pb_accept_clicked"
};
...
void RegistrationDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RegistrationDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegistrationDialog::registrationComplete)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RegistrationDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_RegistrationDialog.data,
    qt_meta_data_RegistrationDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void RegistrationDialog::registrationComplete()
{
